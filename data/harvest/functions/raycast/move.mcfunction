...
execute if block ~ ~ ~ #minecraft:crops[age=7] run function harvest:raycast/hit_block
execute if block ~ ~ ~ minecraft:beetroots[age=3] run function harvest:raycast/hit_block
execute if block ~ ~ ~ air run tag @s add harvest.ray.continue
execute if block ~ ~ ~ #minecraft:crops unless block ~ ~ ~ #minecraft:crops[age=7] run tag @s add harvest.ray.continue
execute if block ~ ~ ~ beetroots[age=3] run tag @s remove harvest.ray.continue
