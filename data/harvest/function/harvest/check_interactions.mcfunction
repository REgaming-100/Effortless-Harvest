...
execute if score @s harvest.interaction.lifetime matches 1.. store result score #interacterUUID harvest.UUID.0 run data get entity @s attack.player[0]
execute if score @s harvest.interaction.lifetime matches 1.. store result score #interacterUUID harvest.UUID.1 run data get entity @s attack.player[1]
execute if score @s harvest.interaction.lifetime matches 1.. store result score #interacterUUID harvest.UUID.2 run data get entity @s attack.player[2]
execute if score @s harvest.interaction.lifetime matches 1.. store result score #interacterUUID harvest.UUID.3 run data get entity @s attack.player[3]

execute if score @s harvest.interaction.lifetime matches 1.. if score @s harvest.UUID.0 = #interacterUUID harvest.UUID.0 if score @s harvest.UUID.1 = #interacterUUID harvest.UUID.1 if score @s harvest.UUID.2 = #interacterUUID harvest.UUID.2 if score @s harvest.UUID.3 = #interacterUUID harvest.UUID.3 at @s run function harvest:harvest/loot
