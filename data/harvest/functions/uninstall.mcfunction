...
datapack disable "file/Effortless Harvest 1.20.2 1.2.2.zip"
datapack disable "file/Effortless_Harvest.zip"
datapack disable "file/Effortless_Harvest_1.20.2_1.2.2.zip"

datapack disable "file/Effortless Harvest"
datapack disable "file/Effortless Harvest 1.20.2 1.2.2"
datapack disable "file/Effortless_Harvest"
datapack disable "file/Effortless_Harvest_1.20.2_1.2.2"
